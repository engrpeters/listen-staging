...
var Profile = require('./profile.js').Profile; // This code is duplicated in tools/main.js.
  ...
  if (meteorDebugFuture) {
    ...
    setTimeout(function poll() {
      ...
      if (pauseStartTimeMs - waitStartTimeMs > waitLimitMs) {
        console.error(`Debugger did not attach after ${waitLimitMinutes} minutes; continuing.`);
